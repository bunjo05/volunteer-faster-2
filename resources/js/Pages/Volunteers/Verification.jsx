...
export default function Verification() {
    ...
    const handleSubmit = (e) => {
        e.preventDefault();
        post(route("volunteer.verification.store", { volunteer }), {
            data: data,
            forceFormData: true,
            onSuccess: () => reset(),
        });
            ...
            <div className="max-w-2xl p-8 mx-auto bg-white rounded-lg shadow-sm border border-gray-100">
                <div className="mb-8 text-center">
                    ...
                    <p className="mt-2 text-gray-600">
                        Upload your documents to verify your volunteer's
                        identity
                    </p>
                </div>
                    ...
                    <div className="p-6 bg-gray-50 rounded-lg">
                        ...
                        <div className="mb-4">
                            ...
                            <select
                                ...
                                onChange={(e) =>
                                    setData("verification_type", e.target.value)
                                }
                                className="w-full p-3 border border-gray-300 rounded-md focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                                required
                            >
                                <option value="">Select document type</option>
                                <option value="Identification Card">
                                    Identification Card
                                </option>
                        ...
                        <div>
                            ...
                            {data.document && (
                                <p className="mt-2 text-sm text-green-600">
                                    Selected file: {data.document.name}
                                </p>
                            )}
                        </div>
                    </div>
