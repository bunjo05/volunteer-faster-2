            ...
            <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
                ...
                <div className="text-center mb-12">
                    ...
                    <p className="text-xl text-gray-600 max-w-3xl mx-auto">
                        ...
                        information. By using our platform, you acknowledge and
                    ...
                    <div className="flex items-start">
                        ...
                        <div>
                            ...
                            <p className="text-gray-700">
                                ...
                                providing a seamless volunteering experience.
                                This policy outlines our data practices, your
                                rights, and how we maintain the security and
                    ...
                    <div className="bg-white rounded-xl border border-gray-200 p-6">
                        ...
                        <div className="mt-6 bg-gray-50 rounded-lg p-4">
                            <p className="text-sm text-gray-600">
                                <strong>Note:</strong> While we implement robust
                                security measures, no system can guarantee 100%
                                security. We continuously monitor and improve
                ...
                <div className="grid md:grid-cols-3 gap-6 mb-12">
                    ...
                    <div className="bg-white rounded-xl border border-gray-200 p-6">
                        ...
                        <p className="text-gray-700 text-sm mb-4">
                            ...
                            analyze platform usage. Manage preferences through
                    ...
                    <div className="bg-white rounded-xl border border-gray-200 p-6">
                        ...
                        <p className="text-gray-700 text-sm mb-4">
                            Our platform may contain external links. We are not
                    ...
                    <div className="bg-white rounded-xl border border-gray-200 p-6">
                        ...
                        <p className="text-gray-700 text-sm mb-4">
                            Our services are for users 18+. We do not knowingly
                            collect data from children and promptly delete any
                            inadvertently collected information.
                        </p>
                ...
                <div className="bg-gradient-to-r from-gray-50 to-blue-50 rounded-2xl p-8">
                    <div className="grid md:grid-cols-2 gap-8">
                        ...
                        <div>
                            ...
                            <p className="text-gray-700 mb-4">
                                For questions about this Privacy Policy or to
                                exercise your rights, please contact our privacy
                                team.
                            </p>
                ...
                <div className="mt-8 text-center">
                    <p className="text-gray-600 text-sm">
                        By using Volunteer Faster, you acknowledge that you have
                        read, understood, and agree to this Privacy Policy and
                        our{" "}
                        <a
                            href="/terms"
