...
export default function Cookies({ auth }) {
    ...
    // Page-specific SEO
    const pageTitle = "Cookie Policy | Volunteer Faster";
    const pageDescription =
        "Learn how Volunteer Faster uses cookies and similar technologies. Understand cookie types, manage your preferences, and protect your privacy.";
    const pageKeywords =
        "cookie policy, website cookies, cookie consent, privacy settings, cookie management, web tracking, data protection";
                ...
                <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
                    ...
                    <div className="text-center mb-12">
                        ...
                        <p className="text-xl text-gray-600 max-w-3xl mx-auto">
                            ...
                            uses cookies and similar technologies to enhance
                            your experience while respecting your privacy and
                            choices.
                        </p>
                    </div>
                        ...
                        <div className="flex items-start">
                            ...
                            <div>
                                ...
                                <p className="text-gray-700">
                                    ...
                                    personalized, and efficient experience on
                                    our platform. We believe in transparency
                                    about what data we collect and how we use
                                    it. You have full control over your cookie
                        ...
                        <div className="grid md:grid-cols-2 gap-8">
                            <div className="bg-white rounded-xl border border-gray-200 p-6">
                                ...
                                <p className="text-gray-700 mb-4">
                                    ...
                                    device when you visit websites. They serve
                                    as memory for websites, enabling them to
                                    recognize your device and remember your
                                    preferences, login status, and other useful
                                    information.
                                </p>
                                <div className="bg-gray-50 rounded-lg p-4">
                                    <p className="text-sm text-gray-600">
                                        <strong>Analogy:</strong> Like a coat
                                        check ticket – you get a token that
                                        helps the system remember what belongs
                                        to you without carrying everything with
                                        you.
                                    </p>
                                </div>
                            </div>
                    ...
                    <section className="mb-12">
                        <div className="bg-gray-50 rounded-2xl p-6">
                            <div className="flex items-center mb-6">
                                ...
                                <div>
                                    ...
                                    <p className="text-gray-600">
                                        Services we integrate with may set their
                                        own cookies
                                    </p>
                                </div>
                            </div>
                            ...
                            <div className="mb-6">
                                <p className="text-gray-700 mb-4">
                                    We partner with trusted third-party services
                                    to enhance platform functionality. These
                                    services may set their own cookies, which
                                    are governed by their respective privacy
                                    policies.
                                </p>
                                ...
                                <div className="space-y-4">
                                    <div className="p-4 bg-blue-50 rounded-lg">
                                        ...
                                        <p className="text-gray-700 text-sm">
                                            When you first visit, use our
                                            consent banner to accept or decline
                                            optional cookies. Your preferences
                                            are saved for future visits.
                                        </p>
                                    </div>
                                    ...
                                    <div className="p-4 bg-gray-50 rounded-lg">
                                        ...
                                        <p className="text-gray-700 text-sm">
                                            Change your mind anytime through
                                            your account settings or by clearing
                                    ...
                                    <div className="p-4 bg-amber-50 rounded-lg">
                                        ...
                                        <p className="text-gray-700 text-sm">
                                            ...
                                            working properly, including login
                    ...
                    <div className="bg-gradient-to-r from-gray-50 to-blue-50 rounded-2xl p-8">
                        <div className="grid md:grid-cols-2 gap-8">
                            <div>
                                ...
                                <p className="text-gray-700 mb-4">
                                    If you have questions about our Cookie
                                    Policy or need assistance with managing your
                                    preferences, our privacy team is here to
                                    help.
                                </p>
                                <a
                            ...
                            <div>
                                ...
                                <p className="text-gray-700 mb-4">
                                    ...
                                    in technology, regulations, or our services.
