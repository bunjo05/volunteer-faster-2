            ...
            <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
                    ...
                    <div className="flex items-start">
                        ...
                        <div>
                            ...
                            <p className="text-gray-700">
                                ...
                                2016/679 is a comprehensive data protection law
                                that gives EU residents control over their
                                personal data. It sets guidelines for the
                                collection, processing, and protection of
                                personal information, regardless of where the
                ...
                <section className="mb-12">
                    <div className="text-center mb-10">
                        ...
                        <p className="text-gray-600 max-w-2xl mx-auto">
                            We collect only the data necessary to provide our
                ...
                <div className="grid md:grid-cols-2 gap-8 mb-12">
                    ...
                    <div className="bg-white rounded-xl border border-gray-200 p-6">
                        ...
                        <p className="text-gray-700 mb-4">
                            When transferring data outside the European Economic
                            Area (EEA), we ensure:
                        </p>
                ...
                <div className="bg-gradient-to-r from-gray-50 to-blue-50 rounded-2xl p-8 mb-12">
                    <div className="grid md:grid-cols-2 gap-8">
                        ...
                        <div>
                            ...
                            <p className="text-gray-700 mb-4">
                                The entity responsible for determining how and
                            ...
                            <div className="space-y-4">
                                <div className="bg-white rounded-lg p-4 border border-gray-200">
                                    ...
                                    <p className="text-sm text-gray-700 mb-2">
                                        Email our Data Protection Officer for
                ...
                <div className="grid md:grid-cols-3 gap-6 mb-12">
                    ...
                    <div className="bg-white rounded-xl border border-gray-200 p-6">
                        ...
                        <p className="text-gray-700 text-sm mb-4">
                            ...
                            for the purposes outlined in our{" "}
                            <Link
                    ...
                    <div className="bg-white rounded-xl border border-gray-200 p-6">
                        ...
                        <p className="text-gray-700 text-sm mb-4">
                            We share data only with trusted partners who comply
                            with GDPR and process data under our instructions.
                        </p>
                    </div>
                    ...
                    <div className="bg-white rounded-xl border border-gray-200 p-6">
                        ...
                        <p className="text-gray-700 text-sm mb-4">
                            Manage your consent preferences in account settings
                            or via our cookie banner. You can withdraw consent
                            at any time.
                        </p>
                        <button className="text-sm text-blue-600 hover:text-blue-800 font-medium">
                            Manage Preferences →
                ...
                <div className="bg-gray-50 rounded-xl p-6 text-center">
                    ...
                    <p className="text-gray-700 max-w-2xl mx-auto">
                        ...
                        changes in regulations, our services, or processing
                        activities. Significant changes will be communicated
