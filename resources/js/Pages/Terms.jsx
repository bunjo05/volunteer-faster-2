...
export default function Terms({ auth }) {
    ...
    const pageDescription =
        "Read Volunteer Faster's Terms and Conditions. Understand our policies for volunteers, organizations, and donors.";
    ...
    return (
        <>
            <Head>
                ...
                <meta
                    name="keywords"
                    content="terms and conditions, volunteer agreement, legal terms, volunteer platform rules"
                />
                ...
                <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
                    ...
                    <div className="text-center mb-12">
                        ...
                        <p className="text-xl text-gray-600 max-w-3xl mx-auto">
                            ...
                            whether you're a volunteer, organization, donor, or
                            visitor.
                        </p>
                    </div>
                        ...
                        <div className="flex items-start">
                            ...
                            <div>
                                ...
                                <p className="text-gray-700">
                                    ...
                                    Conditions. If you do not agree, you may not
                                    use our services. Continued use constitutes
                                    ongoing acceptance.
                                </p>
                            </div>
                        </div>
                    ...
                    <section className="mb-12">
                        <div className="text-center mb-10">
                            ...
                            <p className="text-gray-600 max-w-2xl mx-auto">
                                To use Volunteer Faster, you must meet the
                                following criteria
                            </p>
                        </div>
                        ...
                        <div className="mt-8 bg-blue-50 rounded-xl p-6">
                            <div className="flex items-center">
                                ...
                                <p className="text-gray-700">
                                    <strong>Note:</strong> We may perform
                                    identity verification at any time and
                                    request supporting documents to ensure
                            ...
                            <div className="flex items-center mb-4">
                                ...
                                <div>
                                    ...
                                    <p className="text-gray-700">
                                        ...
                                        <strong>
                                            {" "}
                                            Points are NOT money, have no
                                            monetary value, and cannot be
                                            withdrawn, cashed out, or refunded.
                                        </strong>
                                    </p>
                                </div>
                            </div>
                        ...
                        <div className="bg-gradient-to-r from-green-50 to-emerald-50 rounded-2xl p-6">
                            <div className="flex items-center mb-4">
                                ...
                                <div>
                                    ...
                                    <p className="text-gray-700">
                                        Volunteer Faster allows volunteers to
                                        create fundraising requests for paid
                                        projects
                                    </p>
                                </div>
                            </div>
                                ...
                                <div className="bg-blue-50 rounded-lg p-4">
                                    <div className="flex items-center">
                                        ...
                                        <p className="text-gray-700">
                                            ...
                                            fundraising campaigns must clearly
                                            state how funds will be used and
                    ...
                    <div className="grid md:grid-cols-2 gap-6 mb-12">
                        ...
                        <div className="bg-white rounded-xl border border-gray-200 p-6">
                            ...
                            <p className="text-gray-700 text-sm">
                                ...
                                Harassment, discrimination, or abuse will result
                                in account suspension or termination. See our{" "}
                                <Link
                        ...
                        <div className="bg-white rounded-xl border border-gray-200 p-6">
                            ...
                            <p className="text-gray-700 text-sm">
                                ...
                                copyright laws. Users may not copy, distribute,
                                or modify it without permission.
                            </p>
                        </div>
                        ...
                        <div className="grid md:grid-cols-2 gap-8">
                            ...
                            <div>
                                ...
                                <p className="text-gray-700 mb-4">
                                    ...
                                    informal negotiation. If unresolved,
                                    disputes shall be submitted to mediation or
